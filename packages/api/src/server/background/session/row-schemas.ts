...
export const SessionRowSchema = Schema.Struct({
  ...
  github_installation_id: Schema.optional(Schema.NullOr(Schema.Number)),
  github_repo_id: Schema.optional(Schema.NullOr(Schema.Number)),
  repo_default_branch: Schema.optional(Schema.NullOr(Schema.String)),
  branch_name: Schema.optional(Schema.NullOr(Schema.String)),
  tools_json: Schema.String,
  custom_mcp_json: Schema.String,
  secret_keys_json: Schema.optional(Schema.String),
  isolate_step_limit: Schema.optional(Schema.Number),
