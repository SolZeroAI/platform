...
import {
  ...
  // oxlint-disable-next-line anti-slop-effect/no-service-constructor-imports -- session Durable Object core is a composition root. It builds the tracing layer at Effect.runPromise edges.
