/* oxlint-disable s0-lint/no-if-statement, s0-lint/no-ternary, effect/avoid-direct-json -- Compact replay reduction is an SDK wire-format boundary; direct guards deliberately discard raw child content while retaining safe lifecycle facts. */
import type {
  SandboxEvent,
  SubagentMilestone,
  SubagentProgress,
